...
                      </div>
                      <div className="p-6">
              _analyzeResumeInternal, onShowAlert, user]); // Depend on _analyzeResumeInternal
...
        />
      ) : (
        <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-dark-100 px-4 sm:px-0">
          <div className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40 dark:bg-dark-50 dark:border-dark-300">
...
                </button>
                <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Resume Score Checker</h1>
...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden dark:bg-dark-100 dark:border-dark-300 dark:shadow-dark-xl">
                  <div className="p-8">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 text-center">Choose Scoring Method</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <button
                        onClick={() => handleSelectScoringMode('jd_based')}
                        className={`p-6 rounded-xl border-2 transition-all duration-300 text-left flex flex-col items-start ${
                          scoringMode === 'jd_based'
                            ? 'border-blue-500 bg-blue-50 shadow-lg dark:border-neon-cyan-500 dark:bg-neon-cyan-500/20'
                            : 'border-gray-200 hover:border-blue-300 hover:bg-gray-50 dark:border-dark-300 dark:hover:border-neon-cyan-400 dark:hover:bg-neon-cyan-500/10'
                        }`}
                      >
                        <div className="flex items-center mb-3">
                          <Target className="w-6 h-6 text-blue-600 dark:text-neon-cyan-400 mr-3" />
...
                          scoringMode === 'general'
                            ? 'border-purple-500 bg-purple-50 shadow-lg dark:border-neon-purple-500 dark:bg-neon-purple-500/20'
                            : 'border-gray-200 hover:border-purple-300 hover:bg-gray-50 dark:border-dark-300 dark:hover:border-neon-purple-400 dark:hover:bg-neon-purple-500/10'
                        }`}
                      >
                        <div className="flex items-center mb-3">
                          <BarChart3 className="w-6 h-6 text-purple-600 dark:text-purple-400 mr-3" />
...
                        <p className="text-gray-600 dark:text-gray-300 text-sm">Get a general assessment of your resume quality against industry standards.</p>
                        {scoringMode === 'general' && (
                          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-dark-300 w-full">
                            <label className="flex items-center space-x-2 cursor-pointer">
                              <input
                                type="checkbox"
                                checked={autoScoreOnUpload}
...
                  <button
                    onClick={() => setCurrentStep(0)}
                    className="text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white flex items-center space-x-2"
                  >
...
                        <div className="bg-gradient-to-br from-blue-100 to-purple-100 p-3 rounded-xl mr-4 dark:from-neon-blue-500/20 dark:to-neon-purple-500/20">
                          <Upload className="w-6 h-6 text-blue-600 dark:text-neon-cyan-400" />
                        </div>
                        <div>
...
                      <div className="p-8">
                        <div className="flex items-center mb-4">
                          <div className="bg-gradient-to-br from-orange-100 to-red-100 p-3 rounded-xl mr-4 dark:from-orange-500/20 dark:to-red-500/20">
...
                      <div className="p-8">
                        <div className="flex items-center mb-4">
                          <div className="bg-gradient-to-br from-green-100 to-blue-100 p-3 rounded-xl mr-4 dark:from-neon-green-500/20 dark:to-neon-blue-500/20">
                            <FileText className="w-6 h-6 text-green-600 dark:text-neon-blue-400" />
                          </div>
                          <div>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">
                              Job Description {scoringMode === 'jd_based' ? <span className="text-red-500">*</span> : '(Optional)'}
                            </h2>
                            <p className="text-gray-600 dark:text-gray-300 mt-1">
                              {scoringMode === 'jd_based'
                                ? 'Paste the complete job description for targeted analysis'
                                : 'Add a job description for more specific analysis.'
                              }
                            </p>
                          </div>
                        </div>
...
                          }
                          rows={6}
                          className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-neon-cyan-500 focus:border-neon-cyan-500 resize-none dark:bg-dark-200 dark:border-dark-300 dark:text-gray-100"
                        />
                      </div>
                    </div>
                  )}
...
                      className={`px-8 py-4 rounded-2xl font-bold text-lg transition-all duration-300 flex items-center space-x-3 mx-auto shadow-xl hover:shadow-2xl ${
                        scoringMode === null || !extractionResult.text.trim() || (scoringMode === 'jd_based' && (!jobDescription.trim() || !jobTitle.trim()))
                          ? 'bg-gray-300 cursor-not-allowed text-gray-500 dark:bg-dark-300 dark:text-dark-400'
                          : 'bg-gradient-to-r from-neon-cyan-500 to-neon-purple-500 hover:from-neon-cyan-400 hover:to-neon-purple-400 text-white hover:shadow-neon-cyan transform hover:scale-105'
                      }`}
                    >
                      <TrendingUp className="w-6 h-6" />
...
                {scoreResult.cached && (
                  <div className="mb-6 bg-blue-50 border border-blue-200 rounded-xl p-4 dark:bg-neon-cyan-500/10 dark:border-neon-cyan-400/50">
                    <div className="flex items-center">
                      <Calendar className="w-5 h-5 text-blue-600 dark:text-neon-cyan-400 mr-3" />
                      <span className="text-sm text-blue-800 dark:text-neon-cyan-300 font-medium">
                        Cached Result from a previous identical scan. This did not use a credit.
                      </span>
                    </div>
                  </div>
                )}
...
                            <circle cx="60" cy="60" r="54" fill="none" strokeWidth="12" className="stroke-gray-200 dark:stroke-dark-300" />
                            <circle
                              cx="60"
                              cy="60"
                              r="54"
...
                              stroke="currentColor"
                              strokeWidth="12"
                              strokeDasharray={`${(scoreResult.overall / 100) * 339.29} 339.29`}
                              strokeLinecap="round"
                              className={`${getScoreColor(scoreResult.overall)} transition-all duration-1000 ease-out`}
                            />
                          </svg>
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className={`text-5xl font-bold ${getScoreColor(scoreResult.overall)}`}>{scoreResult.overall}</span>
                          </div>
                        </div>
                        <h3 className="text-2xl font-bold mt-4 mb-1 text-gray-800 dark:text-gray-100">{scoreResult.match_band}</h3>
                        <p className="text-gray-500 dark:text-gray-400">Overall Match Quality</p>
                      </div>
                      <div>
                        <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Overall Analysis</h3>
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">{scoreResult.analysis}</p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-center">
                          <div className="bg-green-50 p-4 rounded-lg border border-green-200 dark:bg-green-500/10 dark:border-green-500/30">
                            <h4 className="font-semibold text-green-800 dark:text-green-300 mb-1">Key Strengths</h4>
                            <div className="text-lg font-bold text-green-700 dark:text-green-200">
                              {scoreResult.keyStrengths.length} identified
                            </div>
                          </div>
                          <div className="bg-orange-50 p-4 rounded-lg border border-orange-200 dark:bg-orange-500/10 dark:border-orange-500/30">
                            <h4 className="font-semibold text-orange-800 dark:text-orange-300 mb-1">Improvement Areas</h4>
                            <div className="text-lg font-bold text-orange-700 dark:text-orange-200">
                              {scoreResult.improvementAreas.length} identified
                            </div>
                          </div>
                        </div>
                      </div>
...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden dark:bg-dark-100 dark:border-dark-300 dark:shadow-dark-xl mt-8">
                  <div className="p-8">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 flex items-center">
                      <BarChart3 className="w-6 h-6 mr-3 text-indigo-600 dark:text-neon-purple-400" />
                      16-Metric Detailed Breakdown
                    </h2>
...
                        <div key={index}>
                          <div className="flex items-center justify-between mb-2">
                            <h4 className="font-semibold text-gray-800 dark:text-gray-100">{metric.name}</h4>
                            <span className={`font-bold ${getCategoryScoreColor(metric.score, metric.max_score)}`}>
...
                  <div className="p-8">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6 flex items-center">
                      <Lightbulb className="w-6 h-6 mr-3 text-purple-600 dark:text-neon-purple-400" />
                      Actionable Fixes
                    </h2>
...
                        scoreResult.actions.map((action, index) => (
                          <li key={index} className="flex items-start">
                            <div className="w-5 h-5 bg-purple-500 rounded-full flex-shrink-0 mr-4 mt-1 flex items-center justify-center">
...
                {scoringMode === 'jd_based' && (
                  <div className="bg-gradient-to-r from-neon-cyan-500 to-neon-blue-500 rounded-2xl shadow-lg mt-8 p-8 text-white">
...
                      className="bg-white text-neon-blue-500 font-bold py-3 px-6 rounded-xl transition-transform duration-300 hover:scale-105 shadow-lg flex items-center justify-center space-x-2"
                    >
...
                    className="bg-gradient-to-r from-neon-cyan-500 to-neon-blue-500 hover:from-neon-cyan-400 hover:to-neon-blue-400 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 shadow-neon-cyan"
                  >
                    Check Another Resume
                  </button>
                  <button
                    onClick={onNavigateBack}
                    className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-xl transition-all duration-300 dark:bg-dark-300 dark:hover:bg-dark-400 dark:text-gray-200"
                  >
                    Back to Dashboard
                  </button>
                </div>

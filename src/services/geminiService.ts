...
const MAX_INPUT_LENGTH = 50000; // Max characters for combined resume and JD
const MAX_RETRIES = 3;
...
export const optimizeResume = async (
  ...
  projectAnalysis?: any, // Assuming this is part of your existing function signature
  targetRole?: string
): Promise<ResumeData> => {
  // --- NEW: Input Length Check ---
